...
export default function AnimationScroll() {
    return (
        <>
            ...
            <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-3 py-1 rounded bg-yellow-300 text-yellow-900 dark:bg-yellow-700 dark:text-yellow-100 text-sm shadow">
