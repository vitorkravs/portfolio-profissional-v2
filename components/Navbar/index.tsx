    ...
    return (
        <>
            <motion.nav
                ...
                className="lg:fixed lg:left-1/2 lg:-translate-x-1/2 lg:top-6 p-5 w-full max-w-[1000px] justify-end items-center flex md:gap-4 bg-white dark:bg-gray-950 lg:rounded-full md:shadow-lg/30 shadow-main-400 z-50">
                {/* Home Navigation */}
